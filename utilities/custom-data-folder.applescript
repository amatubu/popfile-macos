...
if POPFILE_USER is not equal to "" then
    ...
    do shell script "export VERSIONER_PERL_VERSION=5.18; export POPFILE_ROOT=" & POPFILE_ROOT & "; export POPFILE_USER=" & POPFILE_USER & "; perl -I" & POPFILE_ROOT & "/lib " & POPFILE_ROOT & "/popfile.pl > " & POPFILE_USER & "/console.log 2>&1 &"
end if
