...
if pid is not "" then
    ...
    do shell script "launchctl load /Library/LaunchDaemons/org.getpopfile.popfile.plist; launchctl start org.getpopfile.popfile" with administrator privileges
end if
